...
| Versi | Isi |
|---|---|
| v1.0.2 | Ikon baru (interpretasi logo opencode), first-open cepat — binary pindah ke jniLibs, rootfs mini 4 MB, fix overlay error |
| v1.0.1 | Ikon launcher tema Urahara |
